...
**Oritech Addons One** is an addon for [Oritech](https://github.com/Rearth/Oritech) that introduces **three tiers of extension addons**. Instead of placing many separate addons, you can use these compact versions to significantly reduce the space they occupy.

## ✨ Features

- Three tiers of extension addons
- Saves space compared to vanilla Oritech addons
- Seamless integration with Oritech machines
...
- [Oritech Things](https://github.com/Rearth/Oritech-Things)
